...
public class ScoreServiceServiceLocator extends org.apache.axis.client.Service implements DefaultNamespace.ScoreServiceService {
    ...
    private java.lang.String ScoreService_address = "http://localhost:8080/soap-ws-example/services/ScoreService";
    ...
    public DefaultNamespace.ScoreService getScoreService() throws javax.xml.rpc.ServiceException {
    ...
    public DefaultNamespace.ScoreService getScoreService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            DefaultNamespace.ScoreServiceSoapBindingStub _stub = new DefaultNamespace.ScoreServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (DefaultNamespace.ScoreService.class.isAssignableFrom(serviceEndpointInterface)) {
                DefaultNamespace.ScoreServiceSoapBindingStub _stub = new DefaultNamespace.ScoreServiceSoapBindingStub(new java.net.URL(ScoreService_address), this);
                _stub.setPortName(getScoreServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://DefaultNamespace", "ScoreServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://DefaultNamespace", "ScoreService"));
        }
